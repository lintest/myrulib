...
SQLITE3_STATIC_CFLAGS = -DSQLITE_ENABLE_FTS3 -ISQLite3 $(CPPFLAGS) $(CFLAGS)
SQLITE3_STATIC_OBJECTS =  \
	build/sqlite3_static_sqlite3.o
WXSQLITE3_STATIC_CXXFLAGS = -DNDEBUG -ISQLite3 -IWxSQLite3 `$(WX_CONFIG) \
...
BIN2C_OBJECTS =  \
	build/bin2c_bin2c.o
MYRULIB_CFLAGS = -DNDEBUG -Ibuild -IMyRuLib -IWxSQLite3 -ISQLite3 -O2 \
	`$(WX_CONFIG) --cflags $(WX_CONFIG_FLAGS)` $(CPPFLAGS) $(CFLAGS)
MYRULIB_CXXFLAGS = -DNDEBUG -Ibuild -IMyRuLib -IWxSQLite3 -ISQLite3 -O2 \

...
{
	wxString mask = _("Digital books and archives") + wxT(" (*.fb2; *.zip)|*.zip;*.Zip;*.ZIP;*.fb2;*.Fb2;*.FB2");
	mask += wxT('|') + _("Digital books in FB2") + wxT(" (*.fb2)|*.fb2;*.Fb2;*.FB2");
	mask += wxT('|') + _("ZIP archives")+ wxT(" (*.zip)|*.zip;*.Zip;*.ZIP");
	mask += wxT('|') + _("All files") + wxT(" (*.*)|*.*");
